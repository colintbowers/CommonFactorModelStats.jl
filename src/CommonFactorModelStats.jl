...
This module implements the following statistics for use with common factor models: \n
    - Estimating the number of factors using the methods from Bai, Ng (2002) Determining the Number
    of Factors in Approximate Factor Models
    - Testing whether an observed factor spans the latent common factor space using the methods
